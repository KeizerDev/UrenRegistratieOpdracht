...
namespace DoctrineProxy\__CG__\WellGedaan\UrenRegistratie\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \WellGedaan\UrenRegistratie\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'password', 'salt', 'roles', 'first_name', 'last_name', 'timeCreated', 'enabled'];
        }
